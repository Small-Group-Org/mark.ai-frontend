...
// --- Platform Specific Icons (Simple SVGs or placeholders) ---
...
// Add other platform icons here if specific SVGs are available
// Otherwise, PlatformToggle will render text icons 