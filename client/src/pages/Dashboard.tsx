...
const Dashboard = () => {
  ...
  return (
    <div className={`w-full h-full p-5 border border-gray-300 bg-white overflow-y-auto box-border relative [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden ${isMobileView ? 'h-[calc(100%-64px)]' : ''}`}>
      <ActionScreenHeader
        title="Dashboard"
        timeframe={timeframe}
