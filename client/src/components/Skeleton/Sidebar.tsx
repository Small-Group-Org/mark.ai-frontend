...
const Sidebar: React.FC<SidebarProps> = ({ className = '' }) => {
  return (
    <div 
      className={`w-[90px] h-screen bg-[#0E2D60] fixed left-0 top-0 flex flex-col items-center ${className}`}
    >
      {/* Logo Area */}
      <div className="mt-8 mb-12">
        <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center">
          <span className="text-[#0E2D60] font-bold text-xl">S</span>
        </div>
      </div>

      {/* Menu Items */}
      <div className="flex flex-col items-center gap-8">
        <button className="w-12 h-12 rounded-md bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
        ...
        <button className="w-12 h-12 rounded-md flex items-center justify-center hover:bg-white/10 transition-colors">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
